...
def captureAndProcess(conf, gmail_password):
            ...
            if (timestamp - lastUploaded).seconds >= conf["min_upload_seconds"]:
                ...
                if motionCounter >= conf["min_motion_frames"]:
                    ...
                    if 'email_to' in conf:
                        ...
                        emailapp.sendEmailUsingGmail(t.path, conf["email_to"], 'Security Image', conf["gmail_user"],
                                                     gmail_password)
                        t.cleanup()
                    else:
...
if __name__ == '__main__':
    ...
    captureAndProcess(conf,  gmail_password)
